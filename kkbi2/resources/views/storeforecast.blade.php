        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h1 pt-2 text-center">{{ __('Store Forecasting') }}</h1>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <label class="m-1"><strong>Store:</strong></label>
        ...
        $('#storedropdown').change(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    document.getElementById('month_poly_mape').innerHTML = 'MAPE = ' + result[4][1];
                    document.getElementById('month_poly_rmse').innerHTML = 'RMSE = ' + result[4][0];
                },
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    document.getElementById('year_poly_mape').innerHTML = 'MAPE = ' + result[4][1];
                    document.getElementById('year_poly_rmse').innerHTML = 'RMSE = ' + result[4][0];
                },
                error: function(result) {
                    console.log("error");
                }
